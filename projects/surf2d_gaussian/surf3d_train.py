...
from extends.surf2dgaussian import config
...
def main(_cfg: DictConfig):
    ...
    _config.sys.sceneCls = "extends.surf2dgaussian.scene.surf_scene.Scene"
    _config.sys.modelCls = "extends.surf2dgaussian.scene.surf_model.Module"
    _config.sys.policyCls = "extends.surf2dgaussian.scene.surf_policy.Policy"
    _config.sys.optimerCls = "gausiansplatting.scene.gs_optimer.Optimer"
    _config.sys.lossCls = "extends.surf2dgaussian.scene.surf_loss.Loss"
    _config.sys.renderCls = "extends.surf2dgaussian.scene.surf_render.Render"
